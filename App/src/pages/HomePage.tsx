    ...
    <div className="flex flex-col gap-12">
      <div className="md:px-32 bg-white shadow-lg py-4 -mt-16 rounded-md flex flex-col text-center gap-4">
        ...
        <span className="text-md sm:text-lg md:text-xl">
          Hot and Cold food on your door step!
        </span>
        <SearchBar
      ...
      <div className="grid md:grid-cols-2">
        ...
        <div className="flex flex-col justify-center items-center text-center gap-4">
          <span className="text-3xl font-bold tracking-tighter gap-4 select-none">
            Order takeaway even faster!
          </span>
          <span>
            Download the GoEat app from playstore and apple store for faster
            ordering and personalised recommentations{" "}
          </span>
          <img src={appDownload} />
        </div>
      </div>
